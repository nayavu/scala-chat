...
final case class DownstreamStartedTyping(senderId: String, recipientId: String) extends Downstream

// Chat member receives a notification that another member stops typing
final case class DownstreamStoppedTyping(senderId: String, recipientId: String) extends Downstream
